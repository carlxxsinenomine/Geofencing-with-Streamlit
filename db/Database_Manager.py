...
class DatabaseManager:
    def __init__(self):
        ...
        self.geo_db = self.client.geospatial_data
        self.drawn_shapes = self.geo_db.shapes
        self.drawn_shapes.create_index([("geometry", "2dsphere")])

    def load_database(self):
        pass

    def insert_data(self, geojson_data):
        self.drawn_shapes.insert_one(geojson_data)
